...
namespace CustomsForgeSongManager.LocalTools
{
    public static class FileTools
    {
        ...
        public static void SaveSettingsToFile(DataGridView dgvCurrent, bool verbose = false)
        {
        ...
        /// <summary>
        /// Validates the Rocksmith installation directory.
        /// If the directory is invalid, it prompts the user to select a valid directory.
        /// </summary>
        public static void ValidateRsDir()
        {
            // validate Rocksmith installation directory
            var rsDir = AppSettings.Instance.RSInstalledDir;
            if (String.IsNullOrEmpty(rsDir) || !Directory.Exists(rsDir))
            {
                // Ask user to select Rocksmith installation directory
                string installDir = "";
                using (var fbd = new FolderBrowserDialog())
                {
                ...
                // If the selected directory does not contain a "dlc" subdirectory
                ...
                AppSettings.Instance.RSInstalledDir = installDir;
